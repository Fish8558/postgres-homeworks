...
def load_file(path_file):
    """Функция для чтения файла, ему присваеваем переменные"""
...
employees_data = load_file(
    '/home/geydarovr/Загрузки/pythonProject/postgres-homeworks/homework-1/north_data/employees_data.csv')
orders_data = load_file(
    '/home/geydarovr/Загрузки/pythonProject/postgres-homeworks/homework-1/north_data/orders_data.csv')
customers_data = load_file(
    '/home/geydarovr/Загрузки/pythonProject/postgres-homeworks/homework-1/north_data/customers_data.csv')
        ...
        with conn.cursor() as cur:
            ...
            for cus in customers_data:
                cur.execute('INSERT INTO customers VALUES (%s,%s,%s) ON CONFLICT (customer_id) DO NOTHING',
                            (cus['customer_id'], cus['company_name'], cus['contact_name']))
                conn.commit()
